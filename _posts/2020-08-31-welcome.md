...
1. Install rbenv
    ...
    {: .box-warning}
    There is a message inviting you to add `export RUBY_CONFIGURE_OPTS="--with-openssl-dir=$(brew --prefix openssl@1.1)"` to your `~/.zshrc`, but I've seen this interferes when installing a ruby version with `rbenv`.
